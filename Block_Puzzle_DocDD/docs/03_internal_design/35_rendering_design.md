...
## 3.3 pygame 実装レイアウト定数（2026-05-16）
...
- `SIDEBAR_X = 392`, `SIDEBAR_Y = 84`, `SIDEBAR_W = 170`, `SIDEBAR_H = 408`
- `NEXT_BOX_X = SIDEBAR_X + 24`, `NEXT_BOX_Y = SIDEBAR_Y + 196`, `NEXT_CELL_SIZE = 16`
- `SETUP_LEVEL_Y = 430`, `SETUP_HELP_Y = 465`, `SETUP_BACK_Y = 495`
