...
本書は、その設計内容を Mermaid 記法で確認できるようにした派生図であり、処理順の補助図である `27_runtime_flowchart_mermaid.md` と対で読む。
...
5. サブ状態図の入力順が `32_state_machine_design.md` および `27_runtime_flowchart_mermaid.md` と一致すること
