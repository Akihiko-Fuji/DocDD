...
# SCORE / LEVEL / LINES は同じ右端へ揃える。
# この位置では1桁目（最下位桁）が SCORE 見出しの R の下付近に収まる。
HUD_VALUE_RIGHT_X = SIDEBAR_X + 132
SCORE_VALUE_X = HUD_VALUE_RIGHT_X
SCORE_VALUE_Y = SIDEBAR_Y + 76
LEVEL_VALUE_X = HUD_VALUE_RIGHT_X
LEVEL_VALUE_Y = SIDEBAR_Y + 176
LINES_VALUE_X = HUD_VALUE_RIGHT_X
LINES_VALUE_Y = SIDEBAR_Y + 249
